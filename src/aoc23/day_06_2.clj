...
(defn solve [[line1 line2]]
  (let [times (parse-all-numbers line1)
        ...
        time (Long/parseLong (apply str times))
        distance (Long/parseLong (apply str distances))]
    (count-possibilities time distance)))
...
(deftest count-possibilities-test
  ...
  (is (= (count-possibilities 71530 940200) 71503)))
